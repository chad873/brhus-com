...
const sectors = [
  {
    title: "Industrial",
    href: "/industrial",
    desc: "Ground-up industrial flex development and value-add acquisitions in Texas, with active projects in The Woodlands, Houston, and Corpus Christi.",
  },
  {
    title: "Commercial",
    href: "/commercial",
  ...
  },
  {
    title: "Residential",
    href: "/residential",
    desc: "Luxury single-family and large-scale multifamily developments across California and Colorado.",
  },
];
...
const news = [
  ...
  {
    date: "2025",
    title: "Corpus Business Park — 80-Acre Industrial Development Underway in Corpus Christi",
    href: "/industrial",
  },
];
    ...
    <div className="bg-white">
          ...
          <div className="absolute inset-0 flex items-end">
            <div className="max-w-7xl mx-auto px-6 pb-16 w-full">
              <h1 className="text-white font-serif text-5xl md:text-6xl font-bold leading-tight mb-6 max-w-3xl" style={{ color: "white" }}>
                Building Real Estate That Lasts.
              </h1>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-16 items-start">
        <div>
          ...
          <p className="text-gray-700 mb-4">
            Bird Rock Holdings is a Texas-based real estate firm specializing in industrial development, commercial acquisitions, and residential development across the highest-growth markets in the U.S.
          </p>
          <p className="text-gray-700 mb-8">
            Led by principal Chad Hart, we bring a hands-on, operator-first approach to every investment — from initial underwriting to construction oversight and long-term asset management.
          </p>
        ...
        <div className="border-l-4 border-[#1b4073] pl-10 flex flex-col justify-center">
          <p className="font-serif text-7xl font-bold text-[#1b4073] leading-none mb-2">384K+</p>
          <p className="text-gray-500 text-sm uppercase tracking-widest">SF Industrial Completed &amp; Underway</p>
          <div className="mt-8 pt-8 border-t border-gray-200">
            <p className="font-serif text-4xl font-bold text-[#1b4073] leading-none mb-2">$50M+</p>
            <p className="text-gray-500 text-sm uppercase tracking-widest">Residential Assets Developed</p>
          </div>
          <div className="mt-8 pt-8 border-t border-gray-200">
            <p className="font-serif text-2xl font-bold text-[#1b4073] leading-none mb-2">TX · CA · AZ · CO</p>
            <p className="text-gray-500 text-sm uppercase tracking-widest">Active Markets</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#f7f6f3] py-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="font-serif text-3xl font-bold mb-3">Real Estate Sectors.</h2>
          <p className="text-gray-600 mb-10 max-w-2xl">
            Bird Rock Holdings operates across three core real estate sectors, each with a disciplined approach to acquisition, development, and long-term value creation.
          </p>
      ...
      <section className="bg-black py-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-[#1b4073] text-6xl font-serif leading-none mb-6">&ldquo;</p>
          <blockquote className="text-white font-serif text-2xl md:text-3xl leading-relaxed mb-8">
            We build and stabilize real assets in the fastest-growing markets in Texas — and beyond.
          </blockquote>
              ...
              <div key={p.name} className="border border-gray-200 group">
                <div className="relative h-52 overflow-hidden">
                  ...
                  <div className="absolute top-3 left-3">
                    <span className="bg-[#1b4073] text-white text-xs px-3 py-1 uppercase tracking-wide">{p.sector}</span>
                  </div>
                </div>
                <div className="p-6">
